...
urlpatterns = patterns('',
    ...
    url(r'^temperatura/historico/(?P<id_estacion>\d+)/', 'stations.queryx.temperatura_historico'),
    url(r'^viento/historico/(?P<id_estacion>\d+)/', 'stations.queryx.viento_historico'),
    url(r'^viento/direccion_historico/(?P<id_estacion>\d+)/', 'stations.queryx.viento_direccion_historico'),
    url(r'^precipitacion/historico/(?P<id_estacion>\d+)/', 'stations.queryx.precipitacion_historico'),
    url(r'^precipitacion/acumulado_dia/(?P<id_estacion>\d+)/', 'stations.queryx.precipitacion_acumulado_dia'),
    url(r'^viento/conteo_direccion/(?P<id_estacion>\d+)/', 'stations.queryx.viento_conteo_direccion'),
