...
class Station(models.Model):
    DEPTOS = ((1, 'Concepcion'), (2, 'San Pedro'), (3, 'Coridillera'), (4, 'Guairá'), (5, 'Caaguazú'), (6, 'Caazapa'),
              (7, 'Itapúa'),
              (8, 'Misiones'), (9, 'Paraguarí'), (10, 'Alto Parana'), (11, 'Central'), (12, 'Neembucu'),
              (13, 'Amambay'), (14, 'Canindeyú'), (15, 'Presidente Hayes'), (16, 'Alto Paraguay'), (17, 'Boqueron'),)
